...
def main():
    ...
    player_mini_court_detections , ball_mini_court_detection = mini_court.convert_bounding_boxes_to_mini_court_coordinates(player_detections,
                                                                                                                           ball_detection,
                                                                                                                           court_keypoints)
    #Creating a Data Structure to store player stats
    player_stats_data = [{
        'frame_num':0,
    ...
    for ball_shot_ind in range(len(ball_shot_frames)-1):
        ...
        ball_shot_time_in_seconds = (end_frame-start_frame)/24 # 24 FPS video
        ...
        speed_of_opponent = distance_covered_by_opponent_meters/ball_shot_time_in_seconds * 3.6 #3.6 to convert m/s to km/h
    ...
    output_video_frames = court_line_detector.draw_keypoints_video(output_video_frames, court_keypoints) 
